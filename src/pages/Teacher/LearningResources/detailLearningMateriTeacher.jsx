...
const DetailLearningMateriTeacher = () => {
    ...
    return (
        <LandingPageLayout>
          <div className="px-4 py-6 container mx-auto">
            <HeadingSection title={course.title} image="/assets/smile_image/icon-5.png" />
         ...
         {location.startsWith("/teacher/learning-resources/exam-speciment") && (
...
export default DetailLearningMateriTeacher