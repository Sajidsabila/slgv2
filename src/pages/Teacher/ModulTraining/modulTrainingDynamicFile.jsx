...
const ModulTrainingDynamicFile = () => {
   const [coursePaginatedData, setCoursePaginatedData ] = useState([]);
        ...
        useEffect(() => {
          const materiDetail = async () => {
            try{
                const response = await detailData({doctype: "Modul Training", id});
      ...
      return (
          <LandingPageLayout>
            <div className="px-4 py-6 container mx-auto">
              <HeadingSection title={course.title ?? "Data Kosong"} image="/assets/smile_image/icon-4.png" />
...
export default ModulTrainingDynamicFile