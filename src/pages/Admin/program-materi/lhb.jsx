...
const ProgramMateriLhb = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const folderPaths = [
        "Home/Program Materi",
        "Home/Program Materi/LHB",
        `Home/Program Materi/LHB/${response.abbr_course}`,
      ];
  ...
  return (
    <AdminLayout>
      <h3 className="font-bold py-7 text-lg">Learning Materi LHB</h3>
      {error && (
                ...
                coursePaginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center flex gap-4">
                      ...
                      <Link
                        to={`/admin/program-materi-LHB/${item.name}`}
...
export default ProgramMateriLhb;
