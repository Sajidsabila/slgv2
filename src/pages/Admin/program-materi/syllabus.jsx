...
const ProgramMateriSyllabus = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const folderPaths = [
        "Home/Program Materi",
        "Home/Program Materi/Syllabus",
        `Home/Program Materi/Syllabus/${response.abbr_course}`,

        `Home/Program Materi/Syllabus/${response.abbr_course}/${response.class_grade}`,
      ];
                ...
                coursePaginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center flex gap-4">
                      ...
                      <Link
                        to={`/admin/program-materi-syllabus/${item.name}`}
...
export default ProgramMateriSyllabus;
