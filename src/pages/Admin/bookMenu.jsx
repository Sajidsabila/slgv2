...
import { getModulTraining, postModulTraining, uploadFileProgramMateri } from "../../api/apiProgramMateri";
...
const handleChange = (e) => {
  ...
  console.log(`[CHANGE] ${name}:`, newValue); // ✅ Debug log
  ...
  const handleDelete = (name) => {
    ...
    // Tambahkan API delete di sini
  };

const handleSubmit = async (e) => {
  e.preventDefault();

  // Validasi file saat bukan edit mode dan tidak ada file lama
  ...
  // Validasi format file jika ada file baru
  if (file) {
  ...
  try {
    ...
    if (!isEditMode || file) {
      ...
      console.log("ini hasil upload", uploadedFile)
