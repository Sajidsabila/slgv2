...
const MainAuth = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${urlLink.url}/api/method/smi.api.login`, {
        usr: formData.email,
    ...
    const token = `${response.data.message.api_key}:${response.data.message.api_secret}`;
    sessionStorage.setItem("token", token);
     ...
     const getUser = {
        full_name: userDetail.data.data.full_name,
        user_image: userDetail.data.data.user_image,
        email: userDetail.data.data.email,
        roles: userDetail.data.data.roles,
        mobile_no: userDetail.data.data.mobile_no,
    };
      login(getUser);
