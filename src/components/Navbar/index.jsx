...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-lg fixed w-full z-50">
      <div className="max-w-screen-lg mx-auto px-3 flex justify-between items-center py-3">
        {/* Mobile Point Badge */}
        {point && (
          <p className="md:hidden py-2 px-3 text-sm bg-slate-700 text-white rounded-full mx-2">
            {point} poin
          </p>
        )}

        {/* Mobile Toggle */}
        <div className="md:hidden ml-auto px-2">
          <img
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex items-center w-full text-base text-gray-800">
          <div className="flex gap-3 xl:text-xl xl:ms-[-25%] 2xl:ms-[-30%]">
          ...
          {(sessionStorage.getItem("token") ||
            ...
            <li className="ml-auto xl:me-[-30%] flex gap-2 items-center">
              {point && (
                <p className="py-2 px-3 text-sm bg-slate-700 text-white rounded-full">
                  {point} poin
                </p>
              )}
              <button
